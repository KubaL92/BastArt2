...
namespace BastArt.Migrations
{
    ...
    [Migration("20191219162831_AddPortfolioTags")]
    partial class AddPortfolioTags
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BastArt.Models.Data.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BastArt.Models.PortfolioTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BastArt.Models.Profile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BastArt.Models.PortfolioTag", b =>
                {
                    ...
                    b.HasOne("BastArt.Models.Data.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId");
                });
            ...
            modelBuilder.Entity("BastArt.Models.User", b =>
                {
                    b.HasOne("BastArt.Models.Profile", "Profile")
                        .WithMany()
